    ...
    >
      ...
      <SidebarInset className="relative z-10 h-svh min-h-0 min-w-0 gap-0 overflow-hidden bg-background md:gap-(--workspace-gap) md:bg-transparent md:py-(--workspace-gap) md:pe-(--workspace-gap) md:ps-0">
        <WorkspaceHeader
          ...
          className="flex h-14 shrink-0 items-center border-b px-4 transition-[height] ease-linear md:h-16 md:rounded-2xl md:border md:border-surface-border group-has-data-[collapsible=icon]/sidebar-wrapper:md:h-12"
        >

    ...
    >
      ...
      <SidebarInset className="h-svh min-h-0 min-w-0 gap-0 overflow-hidden bg-background md:gap-(--workspace-gap) md:bg-muted md:py-(--workspace-gap) md:pe-(--workspace-gap) md:ps-0">
        <header
          ...
          className="flex h-14 shrink-0 items-center border-b bg-background px-4 transition-[height] ease-linear md:h-16 md:rounded-2xl md:border group-has-data-[collapsible=icon]/sidebar-wrapper:md:h-12"
        >
